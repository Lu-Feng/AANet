...
def parse_arguments():
    ...
    parser.add_argument("--candipositive_global", type=float, default=0, help="_")
    parser.add_argument("--candipositive_local", type=float, default=0, help="_")
    # Model parameters
